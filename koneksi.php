...
class database{
    ...
    function tampil_data()
    {
        ...
        function tampil_edit_data($id_barang)
        {
            ...
            {
                mysqli_query($this->koneksi,"update tb_barang set nama_barang='$nama_barang','stok','harga_beli','harga_jual='$harga_jual' where id_barang='$id_barang'");
            }
            ...
            {
                $data = mysqli_query($this->koneksi, "select * from tb_barang where nama_barang'");
                while ($row = mysql_fetch_array($data)){
                    $hasil[] = $row;
          }
          return $hasil;
